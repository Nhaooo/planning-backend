...
from app.api.v1.endpoints import health, employees, weeks, legend, auth, backup, simple_planning, week_templates
...
api_router.include_router(week_templates.router, prefix="/week-templates", tags=["week-templates"])
